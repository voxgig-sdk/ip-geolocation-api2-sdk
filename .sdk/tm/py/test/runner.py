...
class IpGeolocationApi2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpGeolocationApi2TestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IpGeolocationApi2TestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IpGeolocationApi2TestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
