...
describe('exists', async () => {
  ...
  //
  // IpGeolocationApi2SDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof IpGeolocationApi2SDK, true,
      'IpGeolocationApi2SDK.test() must return a client synchronously')
  })
