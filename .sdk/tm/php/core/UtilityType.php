...
// IpGeolocationApi2 SDK utility type

class IpGeolocationApi2Utility
{
    ...
    public static function copy(IpGeolocationApi2Utility $src): IpGeolocationApi2Utility
    {
        $u = new IpGeolocationApi2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
