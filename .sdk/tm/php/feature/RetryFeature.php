...
// IpGeolocationApi2 SDK retry feature
...
class IpGeolocationApi2RetryFeature extends IpGeolocationApi2BaseFeature
{
    ...
    public function init(IpGeolocationApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpGeolocationApi2Context $ctx2, string $url, array $fetchdef) use ($inner): array {
            return $this->_with_retry($ctx2, $url, $fetchdef, $inner);
        };
    }

    private function _with_retry(IpGeolocationApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
    ...
    private function _track(IpGeolocationApi2Context $_ctx, int $attempt, mixed $res, mixed $err, float $wait): void
    {
        $client = $this->client;
