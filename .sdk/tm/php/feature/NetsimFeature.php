...
// IpGeolocationApi2 SDK netsim feature
...
class IpGeolocationApi2NetsimFeature extends IpGeolocationApi2BaseFeature
{
    ...
    private function _simulate(IpGeolocationApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpGeolocationApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
