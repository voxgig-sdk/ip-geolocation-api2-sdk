...
// IpGeolocationApi2 SDK ratelimit feature
...
class IpGeolocationApi2RatelimitFeature extends IpGeolocationApi2BaseFeature
{
    ...
    private function _acquire(IpGeolocationApi2Context $ctx): void
    {
    ...
    private function _track(IpGeolocationApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
