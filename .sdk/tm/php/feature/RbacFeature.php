...
// IpGeolocationApi2 SDK rbac feature
...
class IpGeolocationApi2RbacFeature extends IpGeolocationApi2BaseFeature
{
    ...
    private function _required(IpGeolocationApi2Context $ctx): ?string
    {
    ...
    private function _reject(IpGeolocationApi2Context $ctx, string $required): void
    {
    ...
    private function _track(IpGeolocationApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
