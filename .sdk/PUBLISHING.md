...
|---|---|---|
| `ts/` | @voxgig-sdk/ip-geolocation-api2-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ip-geolocation-api2-sdk \
      --repository voxgig-sdk/ip-geolocation-api2-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ip-geolocation-api2-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ip-geolocation-api2-sdk --id=<id>` removes it.
