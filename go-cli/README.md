...
AQL-driven CLI and REPL for the IpGeolocationApi2 SDK. Positional arguments are
...
```sh
go build -o ip-geolocation-api2-cli ./...
```
...
./ip-geolocation-api2-cli list entity1
./ip-geolocation-api2-cli load 1 entity1
./ip-geolocation-api2-cli load '{id:1}' entity1
