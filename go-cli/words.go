...
func registerSDKWords(r *eng.Registry, client *sdk.IpGeolocationApi2SDK) {
...
func runOp(client *sdk.IpGeolocationApi2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
