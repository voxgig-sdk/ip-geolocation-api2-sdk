...
type Args struct {
	Entity string         `json:"entity" jsonschema:"entity1 | entity2 | entity3 | info"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IpGeolocationApi2SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-geolocation-api2_list",
		Description: "List records from IpGeolocationApi2. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-geolocation-api2_load",
		Description: "Load a single record from IpGeolocationApi2. " +
...
func runOp(client *sdk.IpGeolocationApi2SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IpGeolocationApi2SDK, name string) (sdk.IpGeolocationApi2Entity, error) {
	switch strings.ToLower(name) {
	case "entity1":
		return client.Entity1(nil), nil
	case "entity2":
		return client.Entity2(nil), nil
	case "entity3":
		return client.Entity3(nil), nil
	case "info":
