// Command IpGeolocationApi2-mcp is an MCP server exposing the IpGeolocationApi2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IpGeolocationApi2_list  — list records of an entity
//	IpGeolocationApi2_load  — load a single record of an entity
//
