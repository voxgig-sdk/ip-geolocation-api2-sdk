...
// IpGeolocationApi2 SDK cache feature
...
class IpGeolocationApi2CacheFeature extends IpGeolocationApi2BaseFeature
{
    ...
    private function _through(IpGeolocationApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
