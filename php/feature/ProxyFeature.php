...
// IpGeolocationApi2 SDK proxy feature
...
class IpGeolocationApi2ProxyFeature extends IpGeolocationApi2BaseFeature
{
    ...
    public function init(IpGeolocationApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpGeolocationApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
