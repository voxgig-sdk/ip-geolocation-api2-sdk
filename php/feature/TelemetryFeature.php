...
// IpGeolocationApi2 SDK telemetry feature
...
class IpGeolocationApi2TelemetryFeature extends IpGeolocationApi2BaseFeature
{
    ...
    private function _close(IpGeolocationApi2Context $ctx, bool $ok): void
    {
