...
// IpGeolocationApi2 SDK timeout feature
...
class IpGeolocationApi2TimeoutFeature extends IpGeolocationApi2BaseFeature
{
    ...
    private function _with_timeout(IpGeolocationApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpGeolocationApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
