...
// IpGeolocationApi2 SDK clienttrack feature
...
class IpGeolocationApi2ClienttrackFeature extends IpGeolocationApi2BaseFeature
{
    ...
    public function PostConstruct(IpGeolocationApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpGeolocationApi2-SDK';
