...
// IpGeolocationApi2 SDK audit feature
...
class IpGeolocationApi2AuditFeature extends IpGeolocationApi2BaseFeature
{
    ...
    private function _emit(IpGeolocationApi2Context $ctx, string $outcome): void
    {
