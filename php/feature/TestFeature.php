...
// IpGeolocationApi2 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IpGeolocationApi2TestFeature extends IpGeolocationApi2BaseFeature
{
    ...
    public function init(IpGeolocationApi2Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IpGeolocationApi2Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = IpGeolocationApi2Param::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IpGeolocationApi2Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IpGeolocationApi2Context $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = IpGeolocationApi2Param::call($ctx, $k);
