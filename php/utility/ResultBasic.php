...
// IpGeolocationApi2 SDK utility: result_basic

class IpGeolocationApi2ResultBasic
{
    public static function call(IpGeolocationApi2Context $ctx): ?IpGeolocationApi2Result
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof IpGeolocationApi2Error) ? $result->err->msg : (string)$result->err;
