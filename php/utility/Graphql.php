...
// IpGeolocationApi2 SDK utility: graphql
//
...
class IpGeolocationApi2Graphql
{
    ...
    // equivalent.
    public static function body(IpGeolocationApi2Context $ctx): mixed
    {
    ...
    public static function errors(IpGeolocationApi2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
