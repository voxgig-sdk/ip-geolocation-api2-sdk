...
// IpGeolocationApi2 SDK utility: fetcher

class IpGeolocationApi2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpGeolocationApi2SDK/1.0)';
    ...
    public static function call(IpGeolocationApi2Context $ctx, string $fullurl, array $fetchdef): array
    {
