...
// IpGeolocationApi2 SDK utility: make_options

class IpGeolocationApi2MakeOptions
{
    ...
    public static function call(IpGeolocationApi2Context $ctx): array
    {
        ...
        //
        // `IpGeolocationApi2Schema::optspec()` is built from the model:
        ...
        $optspec = IpGeolocationApi2Schema::optspec();
