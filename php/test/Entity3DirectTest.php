...
class Entity3DirectTest extends TestCase
{
    public function test_direct_load_entity3(): void
    {
        $setup = entity3_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-entity3", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
