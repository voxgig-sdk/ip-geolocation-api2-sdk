...
// IpGeolocationApi2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpGeolocationApi2SDK::test)
...
{
    private const SDK_CLASS = 'IpGeolocationApi2SDK';
    ...
    private const SDK_BASE = 'ipgeolocationapi2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ipgeolocationapi2_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
