...
class Entity1EntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IP_GEOLOCATION_API2_TEST_ENTITY1_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function entity1_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IP_GEOLOCATION_API2_TEST_ENTITY1_ENTID");
