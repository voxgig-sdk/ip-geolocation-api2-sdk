...
class Entity2EntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IP_GEOLOCATION_API2_TEST_ENTITY2_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $entity2_ref01_data = Helpers::to_map(is_object($entity2_ref01_data_result) && method_exists($entity2_ref01_data_result, 'data_get') ? $entity2_ref01_data_result->data_get() : $entity2_ref01_data_result);
...
function entity2_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IP_GEOLOCATION_API2_TEST_ENTITY2_ENTID");
