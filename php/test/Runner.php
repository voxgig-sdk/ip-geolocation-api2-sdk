...
class IpGeolocationApi2TestRunner
{
    ...
    {
        $live = self::getenv('IP_GEOLOCATION_API2_TEST_LIVE');
        $override = self::getenv('IP_GEOLOCATION_API2_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IP_GEOLOCATION_API2_TEST_EXPLAIN');
...
class_alias('IpGeolocationApi2TestRunner', 'Runner');
class_alias('IpGeolocationApi2Helpers', 'Helpers');
