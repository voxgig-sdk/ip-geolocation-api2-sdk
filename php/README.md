# IpGeolocationApi2 PHP SDK

The PHP SDK for the IpGeolocationApi2 API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Entity1(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->IpGeolocationApi2(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── ipgeolocationapi2_sdk.php          -- Main SDK class
...
The main class (`ipgeolocationapi2_sdk.php`) exports the SDK class
