...
from ipgeolocationapi2_sdk.utility import register

# Load features
from ipgeolocationapi2_sdk.feature.base_feature import IpGeolocationApi2BaseFeature
from ipgeolocationapi2_sdk.features import _has_feature, _make_feature
...
class IpGeolocationApi2SDK:
    ...
    def get_utility(self):
        return IpGeolocationApi2Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IpGeolocationApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Entity1(self, data=None) -> "Entity1Entity":
        ...
        from ipgeolocationapi2_sdk.entity.entity1_entity import Entity1Entity
    ...
    def Entity2(self, data=None) -> "Entity2Entity":
        ...
        from ipgeolocationapi2_sdk.entity.entity2_entity import Entity2Entity
    ...
    def Entity3(self, data=None) -> "Entity3Entity":
        ...
        from ipgeolocationapi2_sdk.entity.entity3_entity import Entity3Entity
        return Entity3Entity(self, data)


    def Info(self, data=None) -> "InfoEntity":
        """Entity factory: client.Info().list() / client.Info().load({"id": ...})."""
        from ipgeolocationapi2_sdk.entity.info_entity import InfoEntity
