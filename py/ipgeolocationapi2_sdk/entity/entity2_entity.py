...
from ipgeolocationapi2_sdk.ipgeolocationapi2_types import (
    Entity2,
    Entity2CreateData,
)
...
class Entity2Entity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return Entity2Entity(self._client, opts)
    ...
    def create(self, reqdata: Entity2CreateData, ctrl=None) -> Entity2:
        utility = self._utility
