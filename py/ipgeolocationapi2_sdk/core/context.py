...
from ipgeolocationapi2_sdk.core.control import IpGeolocationApi2Control
...
from ipgeolocationapi2_sdk.core.helpers import get_ctx_prop, to_map
...
class IpGeolocationApi2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = IpGeolocationApi2Control()
        ...
        if isinstance(sp, IpGeolocationApi2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IpGeolocationApi2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IpGeolocationApi2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return IpGeolocationApi2Operation({})
    ...
    def make_error(self, code, msg):
        return IpGeolocationApi2Error(code, msg, self)
