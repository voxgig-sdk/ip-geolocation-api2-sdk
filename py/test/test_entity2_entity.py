    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set IP_GEOLOCATION_API2_TEST_ENTITY2_ENTID JSON to run live")
        client = setup["client"]
        ...
        entity2_ref01_data = helpers.to_map(runner.entity_data(entity2_ref01_ent.create(entity2_ref01_data, None)))
...
def _entity2_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "IP_GEOLOCATION_API2_TEST_ENTITY2_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("IP_GEOLOCATION_API2_TEST_ENTITY2_ENTID"))
