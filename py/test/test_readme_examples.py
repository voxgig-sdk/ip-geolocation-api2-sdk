# IpGeolocationApi2 SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from ipgeolocationapi2_sdk import IpGeolocationApi2SDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"IpGeolocationApi2SDK": IpGeolocationApi2SDK, "os": os}
        try:
