# IpGeolocationApi2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpGeolocationApi2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpGeolocationApi2SDK(...) and IpGeolocationApi2SDK.test(...) become
#      IpGeolocationApi2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipgeolocationapi2_sdk"
_SDK_CLASS = "IpGeolocationApi2SDK"
