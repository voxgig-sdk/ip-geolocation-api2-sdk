...
func NewEntity3Entity(client *core.IpGeolocationApi2SDK, entopts map[string]any) *Entity3Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Entity3Entity) GetName() string { return e.name }
...
func (e *Entity3Entity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *Entity3Entity) Deleted() bool {
	return e.deleted
}


func (e *Entity3Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEntity3Entity(e.client, opts)
}

func (e *Entity3Entity) Data(args ...any) any {
...
func (e *Entity3Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Entity3; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *Entity3Entity) DataTyped(data ...Entity3) Entity3 {
	if len(data) > 0 {
		return typedFrom[Entity3](e.Data(asMap(data[0])))
	}
	return typedFrom[Entity3](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Entity3 (all fields
// optional at the wire level).
func (e *Entity3Entity) MatchTyped(match ...Entity3) Entity3 {
	if len(match) > 0 {
		return typedFrom[Entity3](e.Match(asMap(match[0])))
	}
	return typedFrom[Entity3](e.Match())
}
...
func (e *Entity3Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Entity3Entity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// Entity3LoadMatch and returns an Entity3. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *Entity3Entity) LoadTyped(reqmatch Entity3LoadMatch, ctrl map[string]any) (Entity3, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Entity3{}, err
	}
	return typedFrom[Entity3](res), nil
}



func (e *Entity3Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *Entity3Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Entity3Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Entity3Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Entity3Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
