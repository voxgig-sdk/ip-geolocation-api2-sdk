...
func NewEntity1Entity(client *core.IpGeolocationApi2SDK, entopts map[string]any) *Entity1Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Entity1Entity) GetName() string { return e.name }
...
func (e *Entity1Entity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *Entity1Entity) Deleted() bool {
	return e.deleted
}


func (e *Entity1Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEntity1Entity(e.client, opts)
}

func (e *Entity1Entity) Data(args ...any) any {
...
func (e *Entity1Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Entity1; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *Entity1Entity) DataTyped(data ...Entity1) Entity1 {
	if len(data) > 0 {
		return typedFrom[Entity1](e.Data(asMap(data[0])))
	}
	return typedFrom[Entity1](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Entity1 (all fields
// optional at the wire level).
func (e *Entity1Entity) MatchTyped(match ...Entity1) Entity1 {
	if len(match) > 0 {
		return typedFrom[Entity1](e.Match(asMap(match[0])))
	}
	return typedFrom[Entity1](e.Match())
}
...
func (e *Entity1Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Entity1Entity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// Entity1LoadMatch and returns an Entity1. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *Entity1Entity) LoadTyped(reqmatch Entity1LoadMatch, ctrl map[string]any) (Entity1, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Entity1{}, err
	}
	return typedFrom[Entity1](res), nil
}



func (e *Entity1Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *Entity1Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Entity1Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Entity1Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Entity1Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
