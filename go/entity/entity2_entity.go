...
type Entity2Entity struct {
	name    string
	client  *core.IpGeolocationApi2SDK
...
func NewEntity2Entity(client *core.IpGeolocationApi2SDK, entopts map[string]any) *Entity2Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Entity2Entity) GetName() string { return e.name }
...
func (e *Entity2Entity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *Entity2Entity) Deleted() bool {
	return e.deleted
}


func (e *Entity2Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEntity2Entity(e.client, opts)
}

func (e *Entity2Entity) Data(args ...any) any {
...
func (e *Entity2Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Entity2; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *Entity2Entity) DataTyped(data ...Entity2) Entity2 {
	if len(data) > 0 {
		return typedFrom[Entity2](e.Data(asMap(data[0])))
	}
	return typedFrom[Entity2](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Entity2 (all fields
// optional at the wire level).
func (e *Entity2Entity) MatchTyped(match ...Entity2) Entity2 {
	if len(match) > 0 {
		return typedFrom[Entity2](e.Match(asMap(match[0])))
	}
	return typedFrom[Entity2](e.Match())
}
...
func (e *Entity2Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Entity2Entity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *Entity2Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *Entity2Entity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// Entity2CreateData and returns an Entity2. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *Entity2Entity) CreateTyped(reqdata Entity2CreateData, ctrl map[string]any) (Entity2, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Entity2{}, err
	}
	return typedFrom[Entity2](res), nil
}



func (e *Entity2Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Entity2Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Entity2Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
