...
The Golang SDK for the IpGeolocationApi2 API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/ip-geolocation-api2-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/ip-geolocation-api2-sdk=../path/to/github.com/voxgig-sdk/ip-geolocation-api2-sdk
```
...
| `Entity1` | `(data map[string]any) IpGeolocationApi2Entity` | Create a Entity1 entity instance. |
| `Entity2` | `(data map[string]any) IpGeolocationApi2Entity` | Create a Entity2 entity instance. |
| `Entity3` | `(data map[string]any) IpGeolocationApi2Entity` | Create a Entity3 entity instance. |
| `Info` | `(data map[string]any) IpGeolocationApi2Entity` | Create a Info entity instance. |
...
```
github.com/voxgig-sdk/ip-geolocation-api2-sdk/
...
The root package (`github.com/voxgig-sdk/ip-geolocation-api2-sdk`) re-exports everything needed
