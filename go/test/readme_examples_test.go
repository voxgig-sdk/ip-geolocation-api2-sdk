...
const testSeed = `map[string]any{"entity": map[string]any{"entity1": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "entity2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "entity3": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "info": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
