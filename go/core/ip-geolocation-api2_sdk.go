...
type IpGeolocationApi2SDK struct {
	Mode     string
...
func (sdk *IpGeolocationApi2SDK) OptionsMap() map[string]any {
...
func (sdk *IpGeolocationApi2SDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IpGeolocationApi2SDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IpGeolocationApi2SDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpGeolocationApi2SDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IpGeolocationApi2SDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IpGeolocationApi2SDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IpGeolocationApi2SDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IpGeolocationApi2SDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpGeolocationApi2SDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IpGeolocationApi2SDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *IpGeolocationApi2SDK {
	...
	sdk := NewIpGeolocationApi2SDK(sdkopts)
	sdk.Mode = "test"
