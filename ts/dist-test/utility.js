...
function envOverride(m) {
    if ('TRUE' === process.env.IP_GEOLOCATION_API2_TEST_LIVE ||
        'TRUE' === process.env.IP_GEOLOCATION_API2_TEST_OVERRIDE) {
    ...
    m.IP_GEOLOCATION_API2_TEST_EXPLAIN = process.env.IP_GEOLOCATION_API2_TEST_EXPLAIN || m.IP_GEOLOCATION_API2_TEST_EXPLAIN;
    return m;
}
