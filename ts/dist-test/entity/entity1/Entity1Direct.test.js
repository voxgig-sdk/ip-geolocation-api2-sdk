...
(0, node_test_1.describe)('Entity1Direct', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IpGeolocationApi2SDK({
    ...
    (0, node_test_1.test)('direct-load-entity1', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-entity1', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IP_GEOLOCATION_API2_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IpGeolocationApi2SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['IP_GEOLOCATION_API2_TEST_ENTITY1_ENTID'];
    ...
    const client = new __1.IpGeolocationApi2SDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=Entity1Direct.test.js.map