...
(0, node_test_1.describe)('Entity3Direct', async () => {
    ...
    (0, node_test_1.test)('direct-load-entity3', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-entity3', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IP_GEOLOCATION_API2_TEST_ENTITY3_ENTID'];
...
//# sourceMappingURL=Entity3Direct.test.js.map