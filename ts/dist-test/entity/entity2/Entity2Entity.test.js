...
(0, node_test_1.describe)('Entity2Entity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'entity2.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != entity2_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/entity2/Entity2TestData.json');
    ...
    let idmap = transform(['entity201', 'entity202', 'entity203'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IP_GEOLOCATION_API2_TEST_ENTITY2_ENTID'];
...
//# sourceMappingURL=Entity2Entity.test.js.map