...
(0, node_test_1.describe)('InfoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [{ "active": true, "name": "dataSources", "req": false, "type": "`$ARRAY`", "index$": 0 }, { "active": true, "format": "date-time", "name": "lastUpdated", "req": false, "type": "`$STRING`", "index$": 1 }, { "active": true, "name": "version", "req": false, "type": "`$STRING`", "index$": 2 }], "name": "info", "op": { "list": { "input": "data", "name": "list", "points": [{ "active": true, "args": {}, "contract": { "id": "GET /info", "json": "{\"parameters\":[],\"protocol\":\"http\",\"responses\":{\"200\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"dataSources\":{\"example\":[\"maxmind\",\"cloudflare\"],\"items\":{\"type\":\"string\"},\"type\":\"array\"},\"lastUpdated\":{\"format\":\"date-time\",\"type\":\"string\"},\"version\":{\"example\":\"4.2.3\",\"type\":\"string\"}},\"type\":\"object\"}}},\"description\":\"Service metadata\"}},\"securitySource\":\"unspecified\"}", "source": "openapi3", "version": 1 }, "kind": "http", "method": "GET", "orig": "/info", "segments": [{ "lit": "info" }], "select": {}, "transform": { "req": "`reqdata`", "res": "`body.dataSources`" }, "index$": 0 }], "key$": "list" } }, "relations": { "ancestors": [] }, "key$": "info", "name__orig": "info", "Name": "Info", "name_": "info", "name-": "info", "NAME": "INFO", "index$": 3 }, { "active": true, "entity": "info", "key$": "BasicInfoFlow", "kind": "basic", "name": "BasicInfoFlow", "param": {}, "step": [{ "active": true, "data": {}, "input": {}, "match": {}, "op": "list", "spec": [], "valid": [{ "apply": "ItemExists", "def": { "ref": "info_ref01" } }], "index$": 0 }] }, 'Info');
        }
...
function basicSetup(extra) {
    ...
    const env = (0, utility_1.envOverride)({
        'IP_GEOLOCATION_API2_TEST_INFO_ENTID': idmap,
        'IP_GEOLOCATION_API2_TEST_LIVE': 'FALSE',
        'IP_GEOLOCATION_API2_TEST_EXPLAIN': 'FALSE',
    });
    idmap = env['IP_GEOLOCATION_API2_TEST_INFO_ENTID'];
    const live = 'TRUE' === env.IP_GEOLOCATION_API2_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['IP_GEOLOCATION_API2_TEST_INFO_ENTID'];
