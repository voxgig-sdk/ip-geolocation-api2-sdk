...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.IPGEOLOCATIONAPI2_TEST_LIVE ||
    'TRUE' === process.env.IPGEOLOCATIONAPI2_TEST_OVERRIDE
  ) {
  ...
  m.IPGEOLOCATIONAPI2_TEST_EXPLAIN = process.env.IPGEOLOCATIONAPI2_TEST_EXPLAIN || m.IPGEOLOCATIONAPI2_TEST_EXPLAIN
