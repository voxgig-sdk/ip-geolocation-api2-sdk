...
class IpGeolocationApi2SDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('IpGeolocationApi2SDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Entity2(entopts?: Record<string, any>) {
    const self = this
    return new Entity2Entity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Entity3(entopts?: Record<string, any>) {
    const self = this
    return new Entity3Entity(self, entopts)
  }
