...
class Entity1Entity
  ...
  def make
    opts = @_entopts.dup
    Entity1Entity.new(@_client, opts)
  end
  ...
  #   as an empty match, so client.Entity1.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Entity1, Hash] the loaded Entity1; raises IpGeolocationApi2Error on failure
