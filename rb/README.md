...
The Ruby SDK for the IpGeolocationApi2 API — an entity-oriented client using idiomatic Ruby conventions.
...
## Install
```bash
gem install voxgig-sdk-ip-geolocation-api2
```

Or add to your `Gemfile`:

```ruby
gem "voxgig-sdk-ip-geolocation-api2"
```
