...
#      offline in seeded test mode (IpGeolocationApi2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IpGeolocationApi2_sdk.rb")
  SDK_CLASS = "IpGeolocationApi2SDK"
  ...
  SDK_BASE = "IpGeolocationApi2_sdk"
