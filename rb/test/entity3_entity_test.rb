...
class Entity3EntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IP_GEOLOCATION_API2_TEST_ENTITY3_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def entity3_basic_setup(extra)
  ...
  entid_env_raw = ENV["IP_GEOLOCATION_API2_TEST_ENTITY3_ENTID"]
