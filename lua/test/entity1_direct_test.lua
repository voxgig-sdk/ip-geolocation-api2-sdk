...
describe("Entity1Direct", function()
  it("should direct-load-entity1", function()
    local setup = entity1_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-entity1", setup.live and "live" or "unit")
...
function entity1_direct_setup(mockres)
