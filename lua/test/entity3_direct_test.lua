...
describe("Entity3Direct", function()
  it("should direct-load-entity3", function()
    local setup = entity3_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-entity3", setup.live and "live" or "unit")
...
function entity3_direct_setup(mockres)
