...
function runner.env_override(m)
  local live = runner.getenv("IPGEOLOCATIONAPI2_TEST_LIVE")
  local override = runner.getenv("IPGEOLOCATIONAPI2_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IPGEOLOCATIONAPI2_TEST_EXPLAIN")
