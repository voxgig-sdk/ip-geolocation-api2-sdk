...
describe("Entity3Entity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set IP_GEOLOCATION_API2_TEST_ENTITY3_ENTID JSON to run live")
      return
    end
...
function entity3_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("IP_GEOLOCATION_API2_TEST_ENTITY3_ENTID")
