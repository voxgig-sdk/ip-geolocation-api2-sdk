...
describe("Entity2Entity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set IP_GEOLOCATION_API2_TEST_ENTITY2_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    entity2_ref01_data = helpers.to_map(type(entity2_ref01_data_result) == 'table' and entity2_ref01_data_result.data_get and entity2_ref01_data_result:data_get() or entity2_ref01_data_result)
...
function entity2_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("IP_GEOLOCATION_API2_TEST_ENTITY2_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["IP_GEOLOCATION_API2_TEST_ENTITY2_ENTID"])
