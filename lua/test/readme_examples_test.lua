...
local SDK_MODULE = "ip-geolocation-api2_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["entity1"] = { ["test01"] = { id = "test01" } }, ["entity2"] = { ["test01"] = { id = "test01" } }, ["entity3"] = { ["test01"] = { id = "test01" } }, ["info"] = { ["test01"] = { id = "test01" } } } }'
