...
```lua
local result, err = client:Entity1(nil):load({ id = "entity1_id" }, nil)
```
...
```lua
local result, err = client:Entity2(nil):create({
}, nil)
```
...
```lua
local result, err = client:Entity3(nil):load({ id = "entity3_id" }, nil)
```
