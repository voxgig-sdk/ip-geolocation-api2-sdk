-- IpGeolocationApi2 SDK Entity2 entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local Entity2Entity = {}
Entity2Entity.__index = Entity2Entity


function Entity2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Entity2Entity)
  self._name = "entity2"
  self._client = client
...
function Entity2Entity:get_name()
  return self._name
end


function Entity2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Entity2Entity.new(self._client, opts)
end
...
function Entity2Entity:mark_deleted()
  self._deleted = true
end


function Entity2Entity:deleted()
  return true == self._deleted
end


function Entity2Entity:data_set(args)
  if args ~= nil then
...
function Entity2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Entity2Entity:match_set(args)
  if args ~= nil then
...
function Entity2Entity:match_get()
...
function Entity2Entity:stream(action, args, callopts)
...
function Entity2Entity:_run_op(ctx, post_done)
  local utility = self._utility
