...
local Entity3Entity = {}
Entity3Entity.__index = Entity3Entity


function Entity3Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Entity3Entity)
  self._name = "entity3"
  self._client = client
...
function Entity3Entity:get_name()
  return self._name
end


function Entity3Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Entity3Entity.new(self._client, opts)
end
...
function Entity3Entity:mark_deleted()
  self._deleted = true
end


function Entity3Entity:deleted()
  return true == self._deleted
end


function Entity3Entity:data_set(args)
  if args ~= nil then
...
function Entity3Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Entity3Entity:match_set(args)
  if args ~= nil then
...
function Entity3Entity:match_get()
...
function Entity3Entity:stream(action, args, callopts)
...
---@param reqmatch Entity3LoadMatch
---@param ctrl? table
---@return Entity3
---@return string? err
function Entity3Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function Entity3Entity:_run_op(ctx, post_done)
  local utility = self._utility
